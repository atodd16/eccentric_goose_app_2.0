...
quad_chart = pd.read_csv(r'https://raw.githubusercontent.com/atodd16/eccentric_goose_app_2.0/refs/heads/master/ec_backend_2.0/data_files/chart_data_files/quad_df.csv')
