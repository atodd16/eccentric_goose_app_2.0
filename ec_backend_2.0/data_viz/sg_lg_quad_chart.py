...
CSV_URL = os.getenv('QUAD_CHART_CSV_URL', 'https://raw.githubusercontent.com/atodd16/eccentric_goose_app_2.0/refs/heads/master/ec_backend_2.0/data_files/chart_data_files/quad_df.csv')
try:
    quad_chart = pd.read_csv(CSV_URL)
except Exception as e:
    raise RuntimeError(f"Failed to load CSV data from {CSV_URL}: {e}")
...
if __name__ == '__main__':
    port = int(os.getenv('PORT', 8080))  # Use the PORT environment variable if available
